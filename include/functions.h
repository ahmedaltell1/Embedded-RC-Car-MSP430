...
void auto_send_to_PC(const char *message);
void process_command(void);
void Reset_IOT(void);


void Forward_Two_Secs(void);
void Backward_Two_Secs(void);
void Left_45(void);
void Right_90(void);
